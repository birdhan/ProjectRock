...
<div class="divBody">
	...
	<div class="divContent">
	  <div style="margin: 20px;">
		...
		<br/>
		<br/>
		<span style="margin-left: 50px;"><a target="_top" href="<c:url value='/regist.jsp'/>"><img src="images/regist1.jpg"></a></span>
		<span style="margin-left: 50px;"><a target="_top" href="<c:url value='/login.jsp'/>"><img src="images/login1.jpg"></a></span>
	  </div>
	</div>
</div>
