 ...
 *
 */
public interface IRegWebServiceDaoMybatis {

	public List selectAllRegWebService();

	@Select("SELECT * FROM SYSTEM_REGWEBSERVICE WHERE ID = #{id}")
	public RegWebService getRegWebServiceById(@Param("id") String id);
