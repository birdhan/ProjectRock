 ...
 *
 */
public interface IRoleUserDaoMybatis {

	public List selectAllRoleUser();

	@Select("SELECT * FROM SYSTEM_ROLEUSER WHERE ID = #{id}")
	public RoleUser getRoleUserById(@Param("id") String id);
