 ...
 *
 */
public interface IRequestRecordDaoMybatis {

	public List selectAllRequestRecord();

	@Select("SELECT * FROM SYSTEM_REQUESTRECORD WHERE ID = #{id}")
	public RequestRecord getRequestRecordById(@Param("id") String id);
