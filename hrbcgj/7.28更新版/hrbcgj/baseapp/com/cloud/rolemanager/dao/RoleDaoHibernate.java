...
public class RoleDaoHibernate extends JdbcHibernateUtil {
	...
	public void delRoleRelation(String roleId) {
		String delRoleUserSql = "delete FROM SYSTEM_ROLEUSER where LINKROLEID='" + roleId + "'";
		jdbcTemplate.update(delRoleUserSql);
		
		String delRoleMenuPrivSql = "delete FROM SYSTEM_ROLEMENUPRIV where LINKROLEID='"+roleId+"'";
