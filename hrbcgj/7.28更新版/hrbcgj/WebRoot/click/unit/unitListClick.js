...
function importData() {
	importWin = $.ligerDialog.open(
		{title:'插件管理数据导入', url: ctx+'/unit/openunitImport.do', height: 265, width: 370, name:'importIframe',isResize: true}
	);
}
...
function exportData() {
	...
	exportWin = $.ligerDialog.open(
		{title:'插件管理数据导出', url: ctx+'/unit/openunitExport.do?ids='+ids, height: 340, width: 470, name:'exportIframe',isResize: true,id:'exportWinDialog'}
	);
}
