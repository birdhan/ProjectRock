...
function addCol(index) {
	...
	col_tr3_td2.innerHTML = "<input type=\"text\" id=\"colType"+index+"\" name=\"colType"+index+"\" value=\"VARCHAR(50)\" onpropertychange=\"checkIsChar(this.value,"+index+")\" autocomplete=\"off\"/>" +
