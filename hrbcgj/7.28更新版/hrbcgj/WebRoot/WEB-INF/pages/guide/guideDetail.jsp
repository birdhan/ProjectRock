...
<body>
<div class="right_title"><p>位置：办事指南详细</p></div>
<div class="tableContentDiv">
<div class="formDiv">
	<table class="tableHead">
		<tr>
			<td><img src="${ctx}/images/formTableTitle.png" class="formTableTitle"/>办事指南详细</td>
		</tr>
	</table>
	...
	<table cellpadding="0" cellspacing="0" border="0" class="formTable">
		...
		<tr>
			<th>创建时间：</th>
			<td align="left" class="formTable_td">
				<fmt:formatDate value="${guide.createtime}" pattern="yyyy-MM-dd HH:mm:ss"/>
			</td>
		</tr>
		<tr>
			<th>详细内容：</th>
