...
<%@ include file="../../../commonjsp/common-top.jsp" %>
	<head>
		<base href="<%=basePath%>">
		<script type="text/javascript" src="${ctx}/click/excelfile/excelFileExportClick.js"></script> <!-- js事件文件 -->
	</head>

<body style="padding: 10px;">
	<form id="exportForm" action="${ctx}/excelfile/exportData.do" method="post">
