	...
	<div id="cgdt_sy">
		...
		<div id="bianji" style=" text-align: center;margin-top: 35px;"><span>标题：</span><input type="text" id="title">
			...
			<div style="text-align: center; margin: 0 auto;">
				<button id="fanhui" onclick="myEmail()" style="background-color: #4bc7ff;font-size: 18px;color: #FFFFFF;">上一步</button>
				<button id="fasong" onclick="saveEmail()" style="margin-left: 75px; background-color: #4bc7ff; font-size: 18px;color: #FFFFFF;">发送</button>
			</div>
		</div>
	</div>
