...
<body>
	...
	<div id="cgdt_sy">
		...
		<div class="cgxw_xqy_title"><span>您当前位置：</span>
				<a href="index.html">首页</a> > <a href="ysqgk.html">依申请公开</a> > 发起申请</div>
				<form action="${pageContext.request.contextPath}/shenqing" method="post" id="form1" name="form1">
			<div id="bianji" style=" text-align: center;margin-top: 35px;"><span>标题：</span><input type="text" id="xqy_title" name="title">
				<br>
				<span style="float: left;margin-left: 220px;">内容：</span>
				<textarea style=" width: 530px; height: 300px; resize: none;margin-left: -180px;" name="actice"> </textarea>
				<br>
				<div style="text-align: center; margin: 0 auto;">
					<!-- <button id="fanhui" style="background-color: #4bc7ff;font-size: 18px;color: #FFFFFF;">上一步</button> -->
					<!-- <button id="fasong" style="margin-left: 75px; background-color: #4bc7ff; font-size: 18px;color: #FFFFFF;">发送</button> -->
					<input type="button" value="提交" id="sub" name="Submit" style="margin-left: 75px; background-color: #4bc7ff; font-size: 18px;color: #FFFFFF;"/>
				</div>
			</div>
			</form>
	</div>
