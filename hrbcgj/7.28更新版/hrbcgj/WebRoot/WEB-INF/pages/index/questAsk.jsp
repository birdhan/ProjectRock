...
<body>
	...
	<div id="cgdt_sy">
		<div class="cgxw_xqy_title"><span>您当前位置：</span>
			<a href="${ctx }/index?sectionId=index">首页</a> ><a href="javascript:void(0);" onclick="myProblem()">问题受理</a> > 我要提问</div>
		<div id="bianji" style=" text-align: center;margin-top: 35px;"><span>标题：</span><input type="text" id="title">
			...
			<div style="text-align: center; margin: 0 auto;">
				<button id="fanhui" onclick="myProblem()" style="background-color: #4bc7ff;font-size: 18px;color: #FFFFFF;">上一步</button>
				<button id="fasong" onclick="savePrbloem()" style="margin-left: 75px; background-color: #4bc7ff; font-size: 18px;color: #FFFFFF;">发送</button>
			</div>
		</div>
	</div>
