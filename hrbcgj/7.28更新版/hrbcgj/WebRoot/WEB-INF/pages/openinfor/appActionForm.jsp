...
<body>
<div class="right_title"><p>位置：依申请公开表单</p></div>
...
<div class="formDiv">
	<form action="${ctx}/openinfor/saveAppAction.do" method="post" name="appActionForm" id="appActionForm">
		...
		<table class="tableHead">
			<tr>
				<td><img src="${ctx}/images/formTableTitle.png" class="formTableTitle"/>依申请公开表单</td>
			</tr>
		</table>
		...
		<table class="formTable">
			<tr>
				<th>标题：</th>
				<td>
					<input name="title" type="text" id="title" value="${appAction.title}" autocomplete="off"/>
				</td>
			</tr>
			<tr>
				<th>内容：</th>
			...
			<tr>
				<th>申请时间：</th>
				<td>
					<input name="createtime" type="text" id="createtime" value="${appAction.createtime}" autocomplete="off"/>
				</td>
			</tr>
			<tr>
				<th>状态：</th>
				<td>
					<input name="state" type="text" id="state" value="${appAction.state}" autocomplete="off"/>
					<%-- <%
