	...
	<div class="formDiv">
		<div class="listDiv">
			<display:table requestURI="${ctx}/openinfor/searchAppAction.do"
				...
				<display:column property="reply" sortable="true" title="回复"
					style="text-align:center;" />
					
					

				<!-- <display:column property="uid" sortable="true" title="用户"
					style="text-align:center;" /> -->
				...
				<display:column title="公开" style="text-align:center">
					<img src="${ctx}/images/delete.png" title="公开"
						style="cursor: pointer;"
						onclick="delDataById('${ctx}/openinfor/saveAppAction.do?id=${appActionList.id}')" />
				</display:column>
