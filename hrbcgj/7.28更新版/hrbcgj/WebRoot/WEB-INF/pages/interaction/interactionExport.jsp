...
<%@ include file="../../../commonjsp/common-top.jsp" %>
	<head>
		<base href="<%=basePath%>">
		<script type="text/javascript" src="${ctx}/click/interaction/interactionExportClick.js"></script> <!-- js事件文件 -->
	</head>

<body style="padding: 10px;">
	<form id="exportForm" action="${ctx}/interaction/exportData.do" method="post">
