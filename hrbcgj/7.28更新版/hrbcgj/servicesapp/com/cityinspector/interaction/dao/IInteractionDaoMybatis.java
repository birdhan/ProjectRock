 ...
 *
 */
public interface IInteractionDaoMybatis {

	public List selectAllInteraction();

	@Select("SELECT * FROM SERVICE_INTERACTION WHERE ID = #{id}")
	public Interaction getInteractionById(@Param("id") String id);
