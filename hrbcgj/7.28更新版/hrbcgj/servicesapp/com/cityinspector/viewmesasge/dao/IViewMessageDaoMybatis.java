 ...
 *
 */
public interface IViewMessageDaoMybatis {

	public List selectAllViewMessage();

	@Select("SELECT * FROM SERVICE_VIEWMESSAGE WHERE ID = #{id}")
	public ViewMessage getViewMessageById(@Param("id") String id);
