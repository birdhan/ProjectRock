 ...
 *
 */
public interface IPremierLetterDaoMybatis {

	public List selectAllPremierLetter();

	@Select("SELECT * FROM SERVICE_PREMIERLETTER WHERE ID = #{id}")
	public PremierLetter getPremierLetterById(@Param("id") String id);
