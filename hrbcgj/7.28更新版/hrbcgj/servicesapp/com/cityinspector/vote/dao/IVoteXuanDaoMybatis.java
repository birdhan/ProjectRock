 ...
 *
 */
public interface IVoteXuanDaoMybatis {

	public List selectAllVoteXuan();

	@Select("SELECT * FROM VOTEXUAN WHERE ID = #{id}")
	public VoteXuan getVoteXuanById(@Param("id") String id);
