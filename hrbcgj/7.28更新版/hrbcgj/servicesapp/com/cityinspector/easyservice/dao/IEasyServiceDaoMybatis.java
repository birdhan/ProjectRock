 ...
 *
 */
public interface IEasyServiceDaoMybatis {

	public List selectAllEasyService();

	@Select("SELECT * FROM EASYSERVICE WHERE ID = #{id}")
	public EasyService getEasyServiceById(@Param("id") String id);
