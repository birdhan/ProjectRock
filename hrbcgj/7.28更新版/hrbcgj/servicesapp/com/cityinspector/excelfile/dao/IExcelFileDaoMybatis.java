 ...
 *
 */
public interface IExcelFileDaoMybatis {

	public List selectAllExcelFile();

	@Select("SELECT * FROM EXCELFILE WHERE ID = #{id}")
	public ExcelFile getExcelFileById(@Param("id") String id);
