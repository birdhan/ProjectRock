 ...
 *
 */
public interface IRegisterUserDaoMybatis {

	public List selectAllRegisterUser();

	@Select("SELECT * FROM REGISTERUSER WHERE ID = #{id}")
	public RegisterUser getRegisterUserById(@Param("id") String id);
