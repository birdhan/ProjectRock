...
function fenye02(value){
	if(value=="end"){
		...
		window.location.href="${pageContext.request.contextPath}/word/findtype?page=${pagenumber }&wordtype="+"${findalllimit[0].wordtype }";
		}
	}else if(value=="down"){
		...
		window.location.href="${pageContext.request.contextPath}/word/findtype?page="+page+"&wordtype="+"${findalllimit[0].wordtype }";
		}
	}else if(value=="up"){
		if("${nowpage}"=="1" ){
			alert("已是第一页");
		...
		window.location.href="${pageContext.request.contextPath}/word/findtype?page="+pagedown+"&wordtype="+"${findalllimit[0].wordtype }";
			
		}
	}else{
		window.location.href="${pageContext.request.contextPath}/word/findtype?page=1&wordtype="+"${findalllimit[0].wordtype }";
	}
...
function shouyeaaa(){
	window.location.href="${pageContext.request.contextPath}/word/first";
}
</script>
	...
	<div class="wrapper">
		...
		<ul>
			<li class="js-btn selected" onclick="shouyeaaa()">热搜文档</li>
		...
		<h3 class="section__title">${findalllimit[0].wordtype }</h3>
