...
function fenye02(value){
	if(value=="end"){
		...
		window.location.href="${pageContext.request.contextPath}/back/articlemanage?page=${pagenumber }";
		}
	}else if(value=="down"){
		...
		window.location.href="${pageContext.request.contextPath}/back/articlemanage?page="+page;
		}
	}else if(value=="up"){
		if("${nownumber}"=="1"){
			alert("已是第一页");
		...
		window.location.href="${pageContext.request.contextPath}/back/articlemanage?page="+pagedown;
			
		}
	}else{
		window.location.href="${pageContext.request.contextPath}/back/articlemanage?page=1";
	}
	
}
function pageoffic(documen,id){
	var heights=window.screen.availHeight;
	var widths=window.screen.availWidth;
	documen.href="javascript:POBrowser.openWindowModeless('word?docxname="+id+"','width="+widths+";height="+heights+";');";
			...
			<div class="col-xs-12 col-sm-9 content">
				<div class="panel panel-default">
					<div class="panel-heading">
						<a class="panel-title" href="#" style="margin-left: 50px;">文章管理</a>
					</div>
						...
						<div class="content-row">
							<table class="table table-bordered">
								...
								<tr>
									...
									<img src="${pageContext.request.contextPath }/images/word1.jpg" width="15px" height="15px">
									&nbsp;
									${findalllimit.wname }
									</td>
									<td>${findalllimit.wordtype }</td>
									<td>${findalllimit.wauthor }</td>
									<td>${findalllimit.worddate }</td>
									<td><a href="#" onclick="pageoffic(this,'${findalllimit.id }')">编辑</a></td>
								</tr>
								</c:forEach>
							</table>
							<div class="separate">
		                    <small>共有${findwordnumber }条数据，分为${pagenumber }页，当前第${nownumber }页</small>
