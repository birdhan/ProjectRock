            ...
            for (int j = 1; j < sheet.getColumns(); j++) {
                ...
                switch (j) {
                    ...
                    case 5:
                        ...
                        break;
                    case 6:
                        monthlyAttendance.setLateNum(Integer.parseInt(cell.getContents()));
                        break;
                    case 7:
                        monthlyAttendance.setEarlyNum(Integer.parseInt(cell.getContents()));
                        break;
                    case 8:
                        monthlyAttendance.setAbsenceNum(Integer.parseInt(cell.getContents()));
                        break;
                    case 9:
                        monthlyAttendance.setCompassionateLeaveNum(Integer.parseInt(cell.getContents()));
                        break;
                    case 10:
                        monthlyAttendance.setBusinessTravelNum(Integer.parseInt(cell.getContents()));
                        break;
                    case 11:
