			...
			<div class="grid-item nike">
			  <div class="grid-item__content-wrapper">
				<div class="ps-shoe mb-30">
				  <div class="ps-shoe__thumbnail"><img src="http://localhost:80/pic/${list.picture}" alt="" height="154.9px"><%-- <a class="ps-shoe__overlay" href="${pageContext.request.contextPath }/details"></a> --%>
				  </div>
