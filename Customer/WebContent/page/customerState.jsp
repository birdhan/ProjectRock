			...
			<div id="show_time">
				...
				function jumpPage()
				{
					...
					function choose(type) {
						...
						window.location.href = "/Customer/selectstatus?cState="
								+ type;
					}
				</script>
			</div>
	...
	<div class="app-body">
		...
		<div class="sidebar">
			...
			<ul class="nav">
				...
				<li class="nav-item open"><a class="nav-link"
		...
		<ol class="breadcrumb">
			...
			<li class="breadcrumb-item active">客户状态</li>
					...
					<c:forEach items="${state }" var="state">
						<div class="col-sm-1">
							...
							<button type="button" class="btn btn-warning"
								onclick="choose('${state.customerstate }')">${state.customerstate }
							</button>
			...
			<div class="col-md-12" style="width: 600px;">
				<div class="card">
					...
					<div class="card-block">
						<form action="/Customer/selectuser" method="post" id="selectuser"
							...
							<div class="form-group row">
								...
								<div class="col-md-9">
									<input type="date" name="zuijindate"
					...
					<div class="card-footer">
						<button type="reset" class="btn btn-sm btn-primary" onclick="submitselect()">
					...
					<div class="card-block">
						<form action="/Customer/updataUser" method="post" id="updata"
							...
							<div class="form-group row">
								...
								<label class="col-md-2 form-control-label" for="email-input">年龄</label>
								<div class="col-md-4">
									<input type="text" id="age" name="age1" class="form-control">
							...
							<div class="form-group row">
								...
								<div class="col-md-4">
									...
									<input type="text" id="user" name="user" class="form-control"
										...
										id="uid"> <input type="hidden" name="cus_sel"
										value="status">
