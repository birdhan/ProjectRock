			...
			<div class="animated fadeIn">
				...
				<table class="table table-hover table-outline mb-0 hidden-sm-down">
					...
					<tbody id="adminTbody">
						...
						<c:forEach items="${orderAll }" var="orderlist">
							<tr>
								<!-- 客户姓名 -->
			...
			<div class="col-md-12" style="width: 600px;">
				<div class="card">
					...
					<div class="card-block">
						<form action="/Customer/selectsomeorder" method="post" id="orderfind"
					...
					<div class="card-footer">
						<button type="reset" class="btn btn-sm btn-primary" onclick="orderfind()">
