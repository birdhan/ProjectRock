...
<body
			...
			<div id="show_time">
				...
				function jumpPage()
				{
					...
					function choose(type) {
						...
						window.location.href = "/Customer/selecttype?cType="
								+ type;
					}
				</script>
			</div>
	...
	<div class="app-body">
		...
		<ol class="breadcrumb">
			...
			<li class="breadcrumb-item active">客户类型</li>
		...
		<div class="container-fluid">
			<div class="animated fadeIn">
				<div class="row">
					...
					<c:forEach items="${type }" var="ctype">
						<div class="col-sm-1">

							<button type="button" class="btn btn-primary"
								onclick="choose('${ctype.customertype }')">${ctype.customertype }
							</button>
