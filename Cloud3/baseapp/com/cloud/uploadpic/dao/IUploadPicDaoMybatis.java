 ...
 *
 */
public interface IUploadPicDaoMybatis {

	public List selectAllUploadPic();

	@Select("SELECT * FROM UPLOADPIC WHERE ID = #{id}")
	public UploadPic getUploadPicById(@Param("id") String id);
