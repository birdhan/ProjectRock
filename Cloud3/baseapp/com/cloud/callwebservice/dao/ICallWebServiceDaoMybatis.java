 ...
 *
 */
public interface ICallWebServiceDaoMybatis {

	public List selectAllCallWebService();

	@Select("SELECT * FROM CALLWEBSERVICE WHERE ID = #{id}")
	public CallWebService getCallWebServiceById(@Param("id") String id);
