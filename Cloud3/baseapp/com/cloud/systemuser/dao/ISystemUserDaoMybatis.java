 ...
 *
 */
public interface ISystemUserDaoMybatis {

	public List selectAllSystemUser();

	@Select("SELECT * FROM SYSTEMUSER WHERE ID = #{id}")
	public SystemUser getSystemUserById(@Param("id") String id);
