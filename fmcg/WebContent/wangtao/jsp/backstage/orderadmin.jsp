 ...
 */
				$(".iframe").colorbox({iframe:true, width:"20%", height:"40%"});
                ...
                <table class="table table-hover">
                  ...
                  <tbody>
                    ...
                    <tr class="table-success">
                      ...
                      <td>￥${list.spay}</td>
                       <td>${list.status}</td>
                        <td><a class="iframe btn btn-success btn-sm " href="${pageContext.request.contextPath }/showorderdetails?id=${list.id}">详情</a></td>
                        <td><a class="btn btn-danger btn-sm ${list.status }" href="${pageContext.request.contextPath }/fahuo?id=${list.id}">立即发货</a></td>
                    </tr>
                    </c:forEach>
                  </tbody>
                </table>
