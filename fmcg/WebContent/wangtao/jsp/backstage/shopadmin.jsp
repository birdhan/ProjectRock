 ...
 */
 ...
 function shanchu(shanchuid){
	
	if(confirm("确认删除本条记录")){
	window.location.href = "${pageContext.request.contextPath}/deletekuaixiaoById?id="
			+ shanchuid;	
	}
} 
		</script>
                ...
                <table class="table table-hover">
                  ...
                  <tbody>
                    ...
                    <tr class="table-success">
                      ...
                      <td>${list.ktype}</td>
                      <td>${list.kcheck}↑</td>
                        <td><a class="iframe btn btn-success btn-sm " href="${pageContext.request.contextPath }/shopupdate?id=${list.id}">修改</a></td>
                        <td><a class="btn btn-danger btn-sm" onclick="shanchu('${list.id}')">删除</a></td>
                    </tr>
                    </c:forEach>
                  </tbody>
                </table>
