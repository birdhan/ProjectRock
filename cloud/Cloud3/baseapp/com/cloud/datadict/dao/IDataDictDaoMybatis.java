 ...
 *
 */
public interface IDataDictDaoMybatis {

	public List selectAllDataDict();

	@Select("SELECT * FROM SYSTEM_DATADICT WHERE ID = #{id}")
	public DataDict getDataDictById(@Param("id") String id);
